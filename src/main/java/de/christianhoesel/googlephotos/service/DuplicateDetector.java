...
public class DuplicateDetector {
    ...
    public boolean isDuplicate(File file, File destDir) {
        ...
        try {
            ...
            if (existsInDestination(file, destDir, key)) {
    ...
    /**
     * Checks if a file with the same key exists in the destination directory structure.
     */
    private boolean existsInDestination(File file, File destDir, String key) {
